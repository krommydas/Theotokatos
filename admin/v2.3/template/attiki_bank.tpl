      ...
      <form action="" method="POST" enctype="multipart/form-data" id="form">
        <table class="form">
         <tr>
           ...
           <tr>
            <td><span class="required">*</span><?php echo $entry_store_id; ?></td>
            <td><input type="text" name="store_id" value="<?php echo $store_id; ?>" /></td>
          </tr>
          <tr>
          ...
          <tr>
            <td><?php echo $order_statuses_lang[$key]; ?></td>
            <td><select name="<?php echo $key; ?>">
                <?php foreach ($order_statuses_suggestions as $option) { ?>
                <?php if ($option['order_status_id'] == $value) { ?>
